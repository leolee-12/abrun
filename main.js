...
function collision(rtan, obstacle) {
  return !(
    rtan.x > obstacle.x + obstacle.width-32 ||
    rtan.x + rtan.width-32 < obstacle.x ||
    rtan.y > obstacle.y + obstacle.height-20 ||
    rtan.y + rtan.height-20 < obstacle.y
  );
}
